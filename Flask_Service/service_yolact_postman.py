...
checkpoint = {
    'm2fSwinT':'../work_dirs/mask2former_t_beta_845/best/iter_42500_514_282.pth',
...
device = 'cuda:0'
cur_config = config['m2fSwinS']
cur_checkpoint = checkpoint['m2fSwinS']
...
if __name__ =="__main__":
    ...
    server = pywsgi.WSGIServer(('10.201.83.51', 5000), app)
